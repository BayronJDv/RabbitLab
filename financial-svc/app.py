...
financial_db = [
    {"id": "12345", "name": "Juan Perez", "bank": "Banco de Bogotá", "account_type": "Cuenta de Ahorros", "credit_score": 750, "status": "Activo"},
    {"id": "67890", "name": "Maria Lopez", "bank": "Bancolombia", "account_type": "Cuenta Corriente", "credit_score": 820, "status": "Activo"},
    {"id": "11111", "name": "Carlos Ruiz", "bank": "Davivienda", "account_type": "Cuenta de Ahorros", "credit_score": 680, "status": "Suspendido"},
    {"id": "22222", "name": "Ana Torres", "bank": "BBVA Colombia", "account_type": "Cuenta Corriente", "credit_score": 795, "status": "Activo"},
]
...
def process_query(ch, method, properties, body):
    ...
    try:
        ...
        if result:
            ...
            logging.info(f"Información financiera encontrada para ID={person_id}: {result['bank']}")
        else:
            response = {
                "id": person_id,
                "status": "not_found",
